...
var defaultSections = [
  ...
  {name:'Generator Yard DH2',desc:'Gen in auto, no unexpected alarms. Check fuel, oil, and coolant levels. Verify battery charger and block heater. Check breaker status. Verify E-Stop is NOT pressed, ball valve is open, no leaks or debris. See Reference Values for specific ranges.',cols:['GEN 2.1C','XMFR 2.1C','GEN 2.6B','XFMR 2.6B','GEN 2.6A','XFMR 2.6A','GEN 2.5B','XFMR 2.5B','GEN 2.5A','XFMR 2.5A','GEN 2.4B','XFMR 2.4B','GEN 2.4A','XFMR 2.4A','GEN 2.3B','XFMR 2.3B','GEN 2.3A','XFMR 2.3A','GEN 2.2B','XMFR 2.2B','GEN 2.2A','XMFR 2.2A','GEN 2.1B','XMFR 2.1B','GEN 2.1A','XMFR 2.1A'],type:'exp_unexp',cheatSheet:'Rating: 2750 kW, 480 VAC, 60 Hz | RPM: 1800 | Battery: 24 Vdc (24-28 Vdc with charger) | Oil pressure: 30-80 PSI (running) | Coolant temp: >100°F standby (block heater), 160-200°F running | Fuel level: >80% | E-Stop: NOT pressed | Ball valve: OPEN | XFMR winding: <105°C alarm, <120°C trip | XFMR liquid: 65-75°C | XFMR pressure: -2 to 6 PSI'},
